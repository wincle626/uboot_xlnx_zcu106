cmd_tools/mtk_image.o := cc -Wp,-MD,tools/.mtk_image.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer  -std=gnu11   -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/mtk_image.o tools/mtk_image.c
