cmd_tools/imx8mimage.o := cc -Wp,-MD,tools/.imx8mimage.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer  -std=gnu11   -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/imx8mimage.o tools/imx8mimage.c
