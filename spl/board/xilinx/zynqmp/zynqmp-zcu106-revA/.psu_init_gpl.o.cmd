cmd_spl/board/xilinx/zynqmp/zynqmp-zcu106-revA/psu_init_gpl.o := aarch64-linux-gnu-gcc -Wp,-MD,spl/board/xilinx/zynqmp/zynqmp-zcu106-revA/.psu_init_gpl.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/7/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -ffunction-sections -fdata-sections -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-zynqmp/include -I./board/xilinx/zynqmp -Wno-int-to-pointer-cast    -D"KBUILD_STR(s)=$(pound)s" -D"KBUILD_BASENAME=KBUILD_STR(psu_init_gpl)"  -D"KBUILD_MODNAME=KBUILD_STR(psu_init_gpl)" -c -o spl/board/xilinx/zynqmp/zynqmp-zcu106-revA/psu_init_gpl.o board/xilinx/zynqmp/zynqmp-zcu106-revA/psu_init_gpl.c

source_spl/board/xilinx/zynqmp/zynqmp-zcu106-revA/psu_init_gpl.o := board/xilinx/zynqmp/zynqmp-zcu106-revA/psu_init_gpl.c

deps_spl/board/xilinx/zynqmp/zynqmp-zcu106-revA/psu_init_gpl.o := \
  arch/arm/include/asm/arch/psu_init_gpl.h \
...
spl/board/xilinx/zynqmp/zynqmp-zcu106-revA/psu_init_gpl.o: $(deps_spl/board/xilinx/zynqmp/zynqmp-zcu106-revA/psu_init_gpl.o)
