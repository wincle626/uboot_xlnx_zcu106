cmd_spl/arch/arm/lib/gic_64.o := aarch64-linux-gnu-gcc -Wp,-MD,spl/arch/arm/lib/.gic_64.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/7/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -D__ASSEMBLY__ -fno-PIE -g -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-zynqmp/include   -c -o spl/arch/arm/lib/gic_64.o arch/arm/lib/gic_64.S

source_spl/arch/arm/lib/gic_64.o := arch/arm/lib/gic_64.S

deps_spl/arch/arm/lib/gic_64.o := \
...
spl/arch/arm/lib/gic_64.o: $(deps_spl/arch/arm/lib/gic_64.o)
